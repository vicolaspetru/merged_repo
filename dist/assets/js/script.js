...
! ( function( a ) {
    ...
    let b, c, d, e, f, g,
        ...
        B = function() {
            let a = document.createElement( 'p' ).style,
        ...
        let e; if ( c.isObj === ! 1 ) {
            ...
            b.updateSize();
        } ), b.st.closeOnContentClick || ( f += ' mfp-auto-cursor' ), f && b.wrap.addClass( f ); let k = b.wH = v.height(),
        ...
        if ( b.isIOS ) {
            let c = document.documentElement.clientWidth / window.innerWidth,
        ...
        if ( ! a( c ).hasClass( s ) ) {
            let d = b.st.closeOnContentClick,
        ...
        let d; d = c ? b.currItem.img : b.st.zoom.opener( b.currItem.el || b.currItem ); let e = d.offset(),
