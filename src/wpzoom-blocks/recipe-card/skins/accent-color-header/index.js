...
class SkinAccentColorHeader extends Component {
    render() {
        ...
        const styles = {
            [ getCSSSelector( activeStyle, '.recipe-card-header-container' ) ]: `background-color: ${ accent_bg_color_header || get( accentBgColors, [ 0, 'color' ] ) }; color: ${ accent_text_color_header || get( accentColors, [ 0, 'color' ] ) };`,
            ...
            [ getCSSSelector( activeStyle, '.detail-item-icon' ) ]: `color: ${ accent_bg_color_header || get( accentBgColors, [ 0, 'color' ] ) };`,
            ...
            [ getCSSSelector( activeStyle, '.tick-circle' ) ]: `border-color: ${ accent_bg_color_header || get( accentBgColors, [ 0, 'color' ] ) }`,
            [ `${ getCSSSelector( activeStyle, '.recipe-card-notes-list' ) } > li::before` ]: `background-color: ${ accent_bg_color_header || get( accentBgColors, [ 0, 'color' ] ) }; color: ${ accent_text_color_header || get( accentColors, [ 0, 'color' ] ) }`,
        };
