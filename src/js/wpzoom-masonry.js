...
( function( $ ) {
	...
	const desktopGridCol = $gridGallery.data( 'grid-columns' ),
	...
	function rebuildMasonry() {
		...
		} else if ( ! $gridGallery.hasClass( `columns-${ mobileGridCol }` ) ) {
	...
	window.rebuildPrintMasonry = ( printWindow ) => {
		$gridGallery = $( document ).find( '.direction-step-gallery' );
		$grid = $( '.direction-step-gallery-grid[data-gallery-masonry-grid="true"]' );
		...
		const gridCol = $gridGallery.data( 'grid-columns' );
