 ...
 *
 * @param root0
 * @param root0.toToolBar
 * @param root0.isOpen
 * @param root0.isDataSet
 * @param root0.ingredients
 * @param root0.steps
 * @param root0._ingredients
 * @param root0._directions
 * @param root0.setAttributes
 * @param root0.setState
 * @param root0.onBulkAdd
 * @return {Component} The Extra Options Modal
 */
