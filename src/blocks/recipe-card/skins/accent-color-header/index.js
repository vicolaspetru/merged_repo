...
class SkinAccentColorHeader extends Component {
	render() {
		...
		const styles = {
			[ getCSSSelector( activeStyle.name, '.recipe-card-header-container' ) ]: `background-color: ${ accent_bg_color_header || get( accentBgColors, [ 0, 'color' ] ) }; color: ${ accent_text_color_header || get( accentColors, [ 0, 'color' ] ) };`,
			[ `${ getCSSSelector( activeStyle.name, '.recipe-card-image' ) } figure img` ]: `border: 10px solid ${ image_border_color || accent_text_color_header || get( accentColors, [ 0, 'color' ] ) };`,
			[ getCSSSelector( activeStyle.name, '.recipe-card-title' ) ]: `color: ${ recipe_title_color || accent_text_color_header || get( titleColors, [ 0, 'color' ] ) };`,
			[ getCSSSelector( activeStyle.name, '.recipe-card-course' ) ]: `color: ${ accent_text_color_header || get( accentColors, [ 0, 'color' ] ) };`,
			[ getCSSSelector( activeStyle.name, '.recipe-card-cuisine' ) ]: `color: ${ accent_text_color_header || get( accentColors, [ 0, 'color' ] ) };`,
			[ getCSSSelector( activeStyle.name, '.recipe-card-difficulty' ) ]: `color: ${ accent_text_color_header || get( accentColors, [ 0, 'color' ] ) };`,
			[ `${ getCSSSelector( activeStyle.name, '.recipe-card-course' ) } mark` ]: `color: ${ meta_color || accent_text_color_header || get( metaTextColors, [ 0, 'color' ] ) };`,
			[ `${ getCSSSelector( activeStyle.name, '.recipe-card-cuisine' ) } mark` ]: `color: ${ meta_color || accent_text_color_header || get( metaTextColors, [ 0, 'color' ] ) };`,
			[ `${ getCSSSelector( activeStyle.name, '.recipe-card-difficulty' ) } mark` ]: `color: ${ meta_color || accent_text_color_header || get( metaTextColors, [ 0, 'color' ] ) };`,
			[ `${ getCSSSelector( activeStyle.name, '.recipe-card-cuisine' ) }::before` ]: `color: ${ accent_text_color_header || get( accentColors, [ 0, 'color' ] ) };`,
			[ `${ getCSSSelector( activeStyle.name, '.recipe-card-difficulty' ) }::before` ]: `color: ${ accent_text_color_header || get( accentColors, [ 0, 'color' ] ) };`,
			[ getCSSSelector( activeStyle.name, '.detail-item-icon' ) ]: `color: ${ accent_bg_color_header || get( accentBgColors, [ 0, 'color' ] ) };`,
			[ getCSSSelector( activeStyle.name, '.btn-pinit-link' ) ]: `background-color: ${ pinterest_bg_color || get( pinterestBackgroundColors, [ 0, 'color' ] ) }; color: ${ pinterest_text_color || get( pinterestTextColors, [ 0, 'color' ] ) };`,
			[ getCSSSelector( activeStyle.name, '.btn-print-link' ) ]: `background-color: ${ print_bg_color || get( printBackgroundColors, [ 0, 'color' ] ) }; color: ${ print_text_color || get( printTextColors, [ 0, 'color' ] ) };`,
			[ getCSSSelector( activeStyle.name, '.wpzoom-rcb-pinit-icon' ) ]: `fill: ${ pinterest_text_color || get( pinterestTextColors, [ 0, 'color' ] ) }`,
			[ getCSSSelector( activeStyle.name, '.wpzoom-rcb-print-icon' ) ]: `fill: ${ print_text_color || get( printTextColors, [ 0, 'color' ] ) }`,
			[ getCSSSelector( activeStyle.name, '.tick-circle' ) ]: `border-color: ${ accent_bg_color_header || get( accentBgColors, [ 0, 'color' ] ) }`,
			[ `${ getCSSSelector( activeStyle.name, '.recipe-card-notes-list' ) } > li::before` ]: `background-color: ${ accent_bg_color_header || get( accentBgColors, [ 0, 'color' ] ) }; color: ${ accent_text_color_header || get( accentColors, [ 0, 'color' ] ) }`,
		};
