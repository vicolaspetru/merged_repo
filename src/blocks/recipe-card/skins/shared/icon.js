...
export const pinterestIcon = <SVG className="wpzoom-rcb-icon-pinit-link" height="30px" id="Pinterest" version="1.1" viewBox="0 0 30 30" width="30px" xmlns="http://www.w3.org/2000/svg">
