...
class FlatTermSelector extends Component {
	...
	render() {
		...
		// translators: %s: Added term name
		const termAddedLabel = sprintf( _x( '%s added', 'term', 'wpzoom-recipe-card' ), singularName );
		// translators: %s: Removed term name
		const termRemovedLabel = sprintf( _x( '%s removed', 'term', 'wpzoom-recipe-card' ), singularName );
		// translators: %s: Remove term name
		const removeTermLabel = sprintf( _x( 'Remove %s', 'term', 'wpzoom-recipe-card' ), singularName );
